    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-r from-purple-600 to-purple-500 text-white py-16">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <a href={`${import.meta.env.BASE_URL}login`} className="inline-block px-10 py-4 bg-white text-purple-600 font-semibold rounded-lg shadow-lg hover:shadow-xl transition">
